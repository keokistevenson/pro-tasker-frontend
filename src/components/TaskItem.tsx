...
function TaskItem({ task, onUpdate, onDelete }: TaskItemProps) {
        ...
        return (
            <article className="card">
                <form onSubmit={handleSubmit}>
                    <div>
                        <label htmlFor={`task-title-${task._id}`}>Title</label>
                        <input
                    ...
                    <div>
                        <label htmlFor={`task-status-${task._id}`}>Status</label>
                        <select
    ...
    return (
        <article
            className="card"
            aria-labelledby={`task-heading-${task._id}`}
        >
            <h3 id={`task-heading-${task._id}`}>
                {task.title}
            </h3>
